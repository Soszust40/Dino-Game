...
BIRD_SPAWN_SCORE = 100
white = (255, 255, 255)
black = (0, 0, 0)
WIN = None

try:
    restart_img = pygame.image.load(os.path.join("data", "restart_button.png"))
    game_over_text_img = pygame.image.load(os.path.join("data", "game_over.png"))
...
try:
    ...
    die_sound = pygame.mixer.Sound(os.path.join("data", "die.wav"))
    score_sound = pygame.mixer.Sound(os.path.join("data", "point.wav"))
except pygame.error as e:
