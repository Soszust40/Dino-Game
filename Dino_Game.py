...
## Created on: 2-24-25 - Last update: 10-8-25
...
class StartMenu(QWidget):
    ...
    def init_ui(self):
        ...
        try:
            ...
            logo_label.setText("Dino Game AI")
...
class SettingsMenu(QWidget):
    ...
    def init_ui(self):
        ...
        self.window_width = QSpinBox(); self.window_width.setRange(400, 1920)
        self.window_height = QSpinBox(); self.window_height.setRange(300, 1080)
    ...
    def restore_defaults(self):
        ...
        if reply == QMessageBox.Yes:
            ...
            QMessageBox.information(self, "Defaults Restored", "UI has been reset to default values. Click 'Save Settings' to apply.")
...
class MainApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QIcon(os.path.join("Data", "icon.png")))
